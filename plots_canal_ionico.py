...
datos_Iter= np.genfromtxt('archivo_salida0.dat')
...
plt.xlabel('x(A)')
plt.ylabel('y(A)')
plt.title('x='+str(x) + ' y='+str(y) + ' r='+str(r) )
...
datos= np.genfromtxt('Canal_ionico1.txt')
datos_Iter= np.genfromtxt('archivo_salida1.dat')
...
plt.ylabel('y(A)')
plt.title('x='+str(x) + ' y='+str(y) + ' r='+str(r) )
fig.savefig('radio_de_poro1.png')

plt.figure()
plt.hist(datos_Iter[:,0], color = 'y')
plt.xlabel('valor x')
plt.ylabel('numero de repeticiones')
plt.savefig('histrogramax1.png')

plt.figure()
plt.hist(datos_Iter[:,1], color = 'b')
plt.xlabel('valor y')
plt.ylabel('numero de repeticiones')
plt.savefig('histrogramay1.png')

plt.figure()
plt.hist(datos_Iter[:,2], color = 'r')
plt.xlabel('valor r')
plt.ylabel('numero de repeticiones')
plt.savefig('histrogramar1.png')
